                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form group">
                                    ...
                                    <input type="text" value="{{ $secretaria->apellidos }}" name="apellidos"
                                        class="form-control" required>
                                    @error('apellidos')
                                        <small style="color:red">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form group">
                                    ...
                                    <input type="text" value="{{ $secretaria->curp }}" name="curp"
                                        class="form-control" required>
                                    @error('curp')
                                        <small style="color:red">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form group">
                                    ...
                                    <input type="text" value="{{ $secretaria->celular }}" name="celular"
                                        class="form-control" required>
                                    @error('celular')
                                        <small style="color:red">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form group">
                                    ...
                                    <input type="date" value="{{ \Carbon\Carbon::parse($secretaria->fecha_nacimiento)->format('Y-m-d') }}" 
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form group">
                                    ...
                                    <input type="email" value="{{ $secretaria->user->email }}" name="email"
                                        class="form-control" required>
                                    @error('email')
                                        <small style="color:red">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="form group">
                                <label for="">Contraseña verificacion</label>
