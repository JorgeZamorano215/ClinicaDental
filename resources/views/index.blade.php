...
<head>
    ...
    <title>{{ $config->nombre ?? 'Dental Gest' }}</title>
    ...
    href="{{ $config && $config->logo 
        ? asset('storage/'.$config->logo) 
        : asset('dist/img/DentalGestLogoOficial.png') }}">
            ...
            <div class="container d-flex justify-content-center justify-content-md-between">
                <div class="contact-info d-flex align-items-center">
                    <i class="bi bi-envelope d-flex align-items-center"><a
                            href="mailto:contact@example.com">{{ $config->correo ?? 'contact@example.com' }} </a></i>
                    <i class="bi bi-phone d-flex align-items-center ms-4"><span>{{ $config->telefono ?? '963 000 00 00' }}</span></i>
                </div>
        ...
        <div class="branding d-flex align-items-center">
            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                <a href="{{ url('/') }}" class="logo d-flex align-items-center me-auto">
                    ...
                    <h1 class="sitename">{{ $config->nombre ?? 'Dental Gest' }}</h1>
                </a>
        ...
        <section id="hero" class="hero section light-background">
            ...
            <div class="container position-relative">
                ...
                <div class="welcome position-relative" data-aos="fade-down" data-aos-delay="100">
                    <h2>Bienvenido</h2>
                    <p>Al centro de atencion medica de tu alcanze</p>
                </div><!-- End Welcome -->
            ...
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6 footer-about">
                    <a href="index.html" class="logo d-flex align-items-center">
                        <span class="sitename">{{ $config->nombre ?? 'Dental Gest' }}</span>
                    </a>
                    <div class="footer-contact pt-3">
                        <p>{{ $config->direccion ?? 'Ubicacion' }}</p>
                        <p class="mt-3"><strong>Teléfono:</strong> <span>{{ $config->telefono ?? '963 000 00 00' }}</span></p>
                        <p><strong>Correo electrónico:</strong> <span>{{ $config->correo ?? 'contact@example.com' }}</span></p>
                    </div>
                    <div class="social-links d-flex mt-4">
                        <a href=""><i class="bi bi-bi-whatsapp"></i></a>
                        <a href=""><i class="bi bi-facebook"></i></a>
                        <a href=""><i class="bi bi-instagram"></i></a>
                    </div>
                </div>
